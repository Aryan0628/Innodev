            ...
            <div className="space-y-4">
              <div className="rounded-lg bg-accent/10 p-4">
                <h4 className="font-medium text-accent mb-1">
                  High Support Detected
                </h4>
                <p className="text-sm text-muted-foreground">
                  Healthcare policy shows 78% support across all demographics.
                  Consider accelerating implementation.
                </p>
              </div>
              ...
              <div className="rounded-lg bg-yellow-500/10 p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Tax Reform policy has polarized opinions. Urban areas show 60%
                  support vs 35% in rural regions.
                </p>
              </div>
              ...
              <div className="rounded-lg bg-blue-500/10 p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Overall policy support has increased by 20% over the past 6
                  months across all simulations.
                </p>
              </div>
            </div>
          </CardContent>
